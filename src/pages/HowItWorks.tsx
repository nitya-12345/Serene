    ...
    <div className="min-h-screen bg-[#FFF9F2] pt-32 pb-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-12">
          <h1 className="text-5xl md:text-6xl font-bold text-[#111217] mb-4">How Serené Works</h1>
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              { q: 'Are there drug interactions?', a: 'No — Serené uses essential oils and contains no prescription ingredients.' }
            ].map((faq, i) => (
